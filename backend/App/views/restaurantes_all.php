        ...
        <div class="col-12">
            <div class="card">
                <div class="table-responsive text-center">
                    <table class="table align-items-center mb-0 table table-striped table-bordered" id="restaurantes-list">
                        <thead>
                            <tr>
                                <!-- <th><input type="checkbox" name="checkAll" id="checkAll" value=""/></th> -->
                                <!-- <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ID</th> -->
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nombre Restaurante</th>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Fecha de la Cota</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Hora de la Cita</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Capacidad</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="Modal_AddLabel">Agregar Restaurante</h5>
                    <button type="button" class="btn btn-danger" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" id="add_restaurante" action="/Restaurantes/restaurantesAdd">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-12" >
                                ...
                                <div class="input-group">
                                    <input id="telefono" name="telefono" maxlength="29" class="form-control" min="0" type="number" placeholder="+52 55 1234 5678" required="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $detalles_registro['telefono'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="col-md-6 col-12" >
                                <label class="form-label">Capacidad *</label>
                                <div class="input-group">
                                    <input id="capacidad" name="capacidad" maxlength="29" class="form-control" min="0" type="number" placeholder="300" required="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $detalles_registro['capacidad'] ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="col-md-12 col-12" >
                                <label class="form-label">Direccion *</label>
                                <div class="input-group">
                                    <textarea id="direccion" name="direccion" class="form-control" type="text" placeholder="Calle s/n #12, Col ..." required="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $detalles_registro['codigo_vestimenta'] ?>" ></textarea>
                                </div>
                            </div>
                            <div class="col-md-12 col-12" >
                                <label class="form-label">Código de Vestimenta *</label>
                                <div class="input-group">
                                    <textarea id="codigo_vestimenta" name="codigo_vestimenta" class="form-control" type="text" placeholder="Zapatos, Camisa, etc..." required="" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $detalles_registro['codigo_vestimenta'] ?>" ></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function borrarRestaurante(dato){
        $.ajax({
            url: "/Restaurantes/borrarRestaurante/"+dato,
            type: "POST",
            dataType: 'json',
            beforeSend: function() {
    ...
    $(document).ready(function() {
        ...
        $('.add_restaurante').on("submit", function(event) {
            ...
            $.ajax({
                ...
                success: function(respuesta) {
                    ...
                    if (respuesta == 'success') {
                        Swal.fire("¡Se ha actualizado correctamente el Restaurante!", "", "success").
                        then((value) => {
                            window.location.reload();
                        });
                    } else {
                        swal("¡No se pudo actualizar correctamente el Restaurante!", "", "warning").
                        then((value) => {
