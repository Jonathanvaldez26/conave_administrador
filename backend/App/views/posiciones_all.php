...
<aside class="bg-white-aside sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
                    ...
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="/Posiciones/">
                                ...
                                <span class="sidenav-normal"> Posiciones</span>
                            </a>
                        </li>
                        <li class="nav-item ">
            ...
            <li class="nav-item">
                <a href="/PruebasCovidUsuario/" class="nav-link " aria-controls="basicExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-auto">
                    <div class="bg-gradient-red avatar avatar-xl position-relative">
                        ...
                        <span class="fa fa-hospital" style="font-size: xx-large;"></span>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="table-responsive text-center">
                    <table class="table align-items-center mb-0 table table-striped table-bordered" id="posiciones-list">
                        <thead>
                        <tr>
