        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a class="text-dark" href="/Principal/">Perfiles</a></li>
                </ol>
            </nav>
  ...
  <div class="right_col">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
      <div class="x_panel tile fixed_height_240">
        ...
        <div class="container-fluid col-md-8 card mt-4">
          <form class="form-horizontal" id="add" action="/Perfiles/perfilEdit" method="POST">
            <div class="form-group ">
              <div class="card-header text-center">
                  <h3>Datos Generales para Editar un Perfil</h3>
              </div>

              <div class="form-group">
                <label class="control-label col-md-12 col-sm-12 col-xs-12" for="nombre">Nombre <span class="required">*</span></label>
              ...
              <!--div class="form-group">
                <label class="control-label col-md-12 col-sm-12 col-xs-12" for="opciones">Opciones de secciones <span class="required">*</span></label>
                <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-group">
                <label class="control-label col-md-12 col-sm-12 col-xs-12" for="descripcion">Descripci&oacute;n <span class="required">*</span></label>
                <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-group">
                <label class="control-label col-md-12 col-sm-12 col-xs-12" for="status">Estatus<span class="required">*</span></label>
                <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="form-group">
                <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-12 col-xs-offset-12 text-center">
