                    ...
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                            <a href="/Lineas/" class="nav-link active" role="button" aria-expanded="false">
                                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center me-2">
                                    <span class="fa fa-pills" style="color: white"></span>
                                </div>
    ...
    <div class="container-fluid py-3 col-md-12">
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-auto">
                    <div class="bg-gradient-red avatar avatar-xl position-relative">
                        ...
                        <span class="fa fa-pills" style="font-size: xx-large;"></span>
                    </div>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <table class="table align-items-center mb-0 table table-striped table-bordered" id="linea-list">
                        <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Bu Perteneciente</th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php echo $tabla; ?>
